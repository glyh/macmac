...
# -*- coding: utf-8 -*-
#
# macmac documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'macmac.tex', 'macmac Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'macmac', 'macmac Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'macmac', 'macmac Documentation',
     author, 'macmac', 'One line description of project.',
     'Miscellaneous'),
]
